...
export const projectDetails = [
    {
        ...
        summary: `Hapyn is an emerging social media platform focused on facilitating connections for professional networking. I implemented an innovative rich text feature that empowers users to craft more comprehensive, visually appealing, and engaging posts.`,
    ...
    },
    {
        ...
        summary: `Hapyn is a growing social media platform with a primary focus on enhancing professional networking opportunities. I revamped their resource section to enable users to create any resource from a single page, streamlining the previous multi-step process.`,
    ...
    },
    {
        ...
        summary: `Magnum Pieiring specializes in the design and production of top-tier steel foundation products. I performed a manual update on the Webpacker gem, transitioning to a more current and supported version while ensuring compatibility and preserving the app's functionality.`,
    ...
    },
    {
        ...
        summary: `Mimi Connect enables families to connect with assisted care facilities, helping them discover the ideal match for their loved ones. I helped implement a new Google Maps feature that allows users to search within a specified radius of their current location and also change their location to explore all available communities.`,
    ...
    },
    {
        ...
        summary: `Mimi Connect empowers families to establish connections with assisted care facilities, facilitating the search for the perfect fit for their loved ones. I assisted in implementing a chat feature that enables users to engage in conversations with the staff at care facilities. All authorized staff members at the care facility will receive notifications when a message is received`,
    ...
    },
    {
        ...
        summary: `Job Trackr is a personal project crafted to serve as a tool for monitoring and optimizing my job search endeavors. This application allows me to meticulously document each application, capturing essential details such as the company name, application date, job title, and my primary point of contact within the organization.`,
        ...
        lessons: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
    },
];